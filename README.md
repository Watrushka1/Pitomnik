...
### 14. Написать [программу](Programm/main.py), имитирующую работу реестра домашних животных.
...
Создал [базу данных](Programm/create_db.sql) и проверил подключение через [Скрипт](Programm/test-bd.py)
Подключение прошло успешно
![screenshot](Db.jpg)

![screenshot](Connection.jpg)

Программа работает. Реализована навигация по меню. Так же реализован пункт 15
